    ...
    public function profileAction(Request $request)
    {
        ...
        if ($user != null) {
            ...
            foreach ($compartments as $cmp) {
                $res = $curlService->httppost('http://45.55.91.141/ss12dashboard/web/app_dev.php/api2', array('compartmentId' => $cmp->getCompartmentId()));
                $res = json_decode($res);
                if ($res != null) {
                    $cmp->temp = $res[0]->temp;
            ...
            return $this->render('user/newProfile.html.twig', array(
                'email' => $email,
